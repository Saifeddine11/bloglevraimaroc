---
title: "New Moroccan passport: changes, documents, fees and validity of the old model"
slug: "new-moroccan-passport-2026-documents-fees-validity"
urlSlug: "new-moroccan-passport-2026-documents-fees-validity"
locale: "en"
translationKey: "nouveau-passeport-marocain-2026"
metaTitle: "New Moroccan passport: changes, documents, fees and validity of the old model"
metaDescription: "New Moroccan passport 2026: Amazigh, English, old passport validity, documents, official procedure and pending details."
category: "guides"
tags: ["new","moroccan","passport","changes,","documents,","fees","and","validity"]
date: 2026-08-03
...
disclaimer: false
---
**Short answer.** The reported reform introduces Amazigh and English into the new biometric passport and removes temporary passports according to Hespress. For documents, fees and tracking, Passeport.ma remains the practical reference.

> **Key takeaways**
> - Old passports should not be considered cancelled without explicit official text.
> - The official portal says passports are issued regardless of age unless a court decision prevents it.
> - Moroccans abroad should use embassies and consulates.
...
| Item | Useful reading |
|---|---|
| 1 | Old passports should not be considered cancelled without explicit official text. |
| 2 | The official portal says passports are issued regardless of age unless a court decision prevents it. |
| 3 | Moroccans abroad should use embassies and consulates. |
...
- Passeport.ma portal active
- Base regulation published
- 2026 reform reported around decree 2.26.551
...
A story such as **New Moroccan passport: changes, documents, fees and validity of the old model** should not be read as a loose chain of news snippets. The useful first step is to separate verified facts, official wording, media interpretation and probable scenarios. This protects readers from two common mistakes: turning an assumption into certainty, or downplaying an important signal because its administrative, economic or diplomatic effects are not yet fully visible.
...
- Confirmed element: Passeport.ma portal active
- Confirmed element: Base regulation published
- Confirmed element: 2026 reform reported around decree 2.26.551
- Monitoring point: Official Bulletin publication
- Monitoring point: Updated forms
- Monitoring point: Confirmed fees
- Monitoring point: Real processing times
