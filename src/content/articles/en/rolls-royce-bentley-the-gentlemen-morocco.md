...
articleType: "Article"
heroCaption: "Privacy crop showing the two vehicle silhouettes without registration plates."
...
The material shows a Rolls-Royce Cullinan and Bentley Bentayga, without proving inclusion in the final edit.

## Key points

- A Rolls-Royce Cullinan is identifiable in the corpus.

- A Bentley Bentayga is identifiable in the same material.

- Registration plates are excluded from published images.

- No on-screen appearance is announced.

## Identifying a model is not identifying a scene

The upright grille, Spirit of Ecstasy, proportions and wheel details support identification of a Rolls-Royce Cullinan. The second SUV carries the grille and winged badge of a Bentley Bentayga. Another image shows an orange-trimmed Rolls-Royce cabin. These observations describe objects present in the supplied material.

They do not show whether the vehicles belong to a character, supported off-camera transport or were ultimately used. The precise wording is therefore “vehicles visible in material supplied by Accrocar”, not “cars seen in Season 3”. The models are documented; their narrative role is not. The photographs belong to the supply entrusted to Accrocar, which, according to first-party information provided to Le Vrai Maroc, is collaborating directly with [Dune Films](https://dunefilms.com/).
...
[Accrocar's luxury-vehicle service](https://accrocar.com/)


## How we verified this information

We compared three evidence sets: Netflix announcements, public institutional or media sources, and first-party material supplied by Accrocar. That method explains why “A Rolls-Royce Cullinan is identifiable in the corpus.” and “A Bentley Bentayga is identifiable in the same material.” may carry different confirmation levels. A date published by Netflix is official; a location named by one outlet remains attributed; an original photograph establishes what is inside the frame, not what happened beyond it.
