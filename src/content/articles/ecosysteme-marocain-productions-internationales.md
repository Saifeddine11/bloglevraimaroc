---
title: "Du repérage au transport : l'écosystème marocain des productions internationales"
slug: "ecosysteme-marocain-productions-internationales"
urlSlug: "ecosysteme-marocain-productions-internationales"
locale: "fr"
translationKey: "ecosysteme-marocain-productions-internationales"
metaTitle: "Du repérage au transport : l'écosystème marocain des productions internationales"
metaDescription: "Comment travaillent les producteurs exécutifs, techniciens, loueurs et logisticiens qui rendent possibles les tournages internationaux au Maroc."
category: "analyses"
tags:
...
readingTime: 6
excerpt: "Le tournage ne repose pas sur un seul prestataire mais sur une chaîne locale où production exécutive, technique et mobilité doivent s'emboîter."
heroImage: "/images/articles/gentlemen-maroc/ecosysteme-production-maroc.webp"
imageAlt: "Ligne de SUV noirs préparés pour une opération audiovisuelle au Maroc"
articleType: "Article"
heroCaption: "Flotte préparée dans le cadre du corpus Accrocar. Aucun lieu opérationnel ni immatriculation n'est visible."
...
Le tournage ne repose pas sur un seul prestataire mais sur une chaîne locale où production exécutive, technique et mobilité doivent s'emboîter.

## L’essentiel

- Production exécutive et coordination territoriale.

- Techniciens, décors, équipements et régie.

- Hébergement, sécurité, mobilité et fournisseurs locaux.

- Incitations et encadrement institutionnel par le CCM.

## Une chaîne où la valeur se crée aux interfaces
...
Dans le cas étudié, Dune Films est citée par Accrocar comme interlocuteur de production et l'opérateur automobile intervient sur un segment circonscrit. Les crédits publics associent par ailleurs The Gentlemen à Moonage Pictures, Miramax Television et Toff Guy Films. La mention « Montage Pictures » transmise par Accrocar n'est pas raccordée documentairement à Moonage; nous maintenons cette distinction.
...
Accrocar représente ici un maillon parmi d'autres: celui de la mobilité spécialisée, dont la qualité dépend de son intégration à la régie générale.
...
Nous avons confronté trois familles de preuves: les annonces de Netflix, les sources publiques institutionnelles ou médiatiques, puis le corpus de première main confié par Accrocar. Cette méthode explique pourquoi « Production exécutive et coordination territoriale. » et « Techniciens, décors, équipements et régie. » ne portent pas nécessairement le même niveau de confirmation. Une date publiée par Netflix est officielle; une localisation rapportée par un média reste attribuée; une photographie originale établit ce qu'elle montre, mais pas ce qui se passe hors cadre.
...
- [Pourquoi les productions internationales choisissent le Maroc](/articles/pourquoi-productions-internationales-choisissent-maroc/)
